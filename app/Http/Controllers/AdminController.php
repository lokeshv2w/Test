...
class AdminController extends Controller
{
    ...
    public function updateProfile(Request $request): RedirectResponse
    {
        ...
        if (!empty($data)) {
            return redirect()->route('admin.profile')->with(['msg' => 'Profile Updated Successfully', 'status' => 'success']);
        } else {
            return redirect()->route('admin.profile')->with(['msg' => 'Please Check Your Credentials', 'status' => 'error']);
        }
    }
    public function updatePassword(Request $request): RedirectResponse
    {
        ...
        if (!empty($data)) {
            return redirect()->route('admin.profile')->with(['msg' => 'Password Updated Successfully', 'status' => 'success']);
        } else {
            return redirect()->route('admin.profile')->with(['msg' => 'Please Check Your Credentials', 'status' => 'error']);
        }
    }
